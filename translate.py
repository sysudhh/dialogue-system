...
tf.app.flags.DEFINE_string("to_train_data", "data/to_train.txt", "Training data.")
tf.app.flags.DEFINE_string("from_dev_data", "data/from_dev.txt", "Training data.")
